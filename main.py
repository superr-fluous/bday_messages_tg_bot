...
\nПосле этого ботом можно управлять через личные сообщения. 
\nОбычный поток действий:
    1. Добавить бота в группу, назначить права администратора
    2. Проверить, что группа появилась в списке доступных групп (/display_all_groups)
    3. Создать поздравление (/create_notification)
    4. Включить отправку созданного поздравления в группе (/active_group_notification)
